          ...
          <div class="flex items-start justify-between gap-3 border-b border-gray-200 p-4 dark:border-dark-700">
            <div class="min-w-0">
              ...
              <div class="mt-1 flex flex-wrap items-center gap-2">
                <span class="break-all font-mono text-sm font-semibold text-gray-900 dark:text-white">{{ keyLabel || '—' }}</span>
                <button
                  v-if="keyLabel"
            ...
            <button
              type="button"
              class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-dark-800"
              @click="close"
            >
