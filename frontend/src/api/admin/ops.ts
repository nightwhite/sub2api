...
export async function getOpenAITokenStats(params: OpsOpenAITokenStatsParams): Promise<OpsOpenAITokenStatsResponse> {
  const { data } = await apiClient.get<OpsOpenAITokenStatsResponse>('/admin/ops/dashboard/openai-token-stats', { params })
  return data
}
