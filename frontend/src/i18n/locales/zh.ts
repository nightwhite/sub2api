  ...
  admin: {
    ...
    ops: {
      ...
      settings: {
        ...
        requestDumpRetentionDays: '请求原文保留天数',
    ...
    settings: {
      ...
      streamTimeout: {
        ...
        timeoutSecondsHint: '流数据间隔超过此时间视为超时（30-3600秒）',
        action: '处理方式',
